...
describe("FEATURE_NAMES", () => {
  it("tiene exactamente 76 columnas en el orden canonico", () => {
    expect(FEATURE_NAMES).toHaveLength(76);
...
describe("extractFeatures - forma del resultado", () => {
  it("devuelve exactamente las 76 claves de FEATURE_NAMES, todas numericas", () => {
